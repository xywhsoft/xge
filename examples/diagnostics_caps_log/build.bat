...
set OUT_DIR=build
set OUT=%OUT_DIR%\xge_diagnostics_caps_log.exe
set SRC=examples\diagnostics_caps_log\main.c
set INC=-I.
...
set LIBS=%XGEDBG_LIB% -lws2_32 -liphlpapi -lgdi32 -luser32 -lshell32 -lopengl32 -lole32 -lwinmm -lavrt
...
echo [XGEDBG] Building diagnostics caps/log EXE...
