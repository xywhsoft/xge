...
set OUT_DIR=build
set OUT=%OUT_DIR%\xge_xui_input_pointer_select_lab.exe
set SRC=xge.c examples\xui_input_pointer_select_lab\main.c
set INC=-I.
...
echo [XGE] Building xui input pointer select lab EXE...
