...
set OUT_DIR=build
set OUT=%OUT_DIR%\xui_input_layer.exe
set SRC=examples\xui_input_layer\main.c src\xui_core.c src\xui_widget.c src\xui_input.c src\xui_proxy_xge.c
set INC=-I.
...
echo [XUI] Building xui_input_layer...
