...
set OUT_DIR=build
set OUT=%OUT_DIR%\xge_xui_xson_layout_gallery_lab.exe
set SRC=examples\xui_xson_layout_gallery_lab\main.c
set INC=-I.
...
echo [XGE] Building xui xson layout gallery lab EXE...
