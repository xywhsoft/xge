...
set OUT_DIR=build
set OUT=%OUT_DIR%\xge_xui_text_history_limit_lab.exe
set SRC=xge.c examples\xui_text_history_limit_lab\main.c
set INC=-I.
...
echo [XGE] Building xui text history limit lab EXE...
