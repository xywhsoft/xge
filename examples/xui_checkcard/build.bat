...
set OUT_DIR=build
set OUT=%OUT_DIR%\xui_checkcard.exe
set SRC=examples\xui_checkcard\main.c src\xui_core.c src\xui_widget.c src\xui_input.c src\xui_text.c src\xui_label.c src\xui_assets.c src\xui_check_card.c src\xui_radio.c src\xui_proxy_xge.c
set INC=-I.
...
echo [XUI] Building xui_checkcard...
