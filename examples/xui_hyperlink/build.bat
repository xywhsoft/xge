...
set OUT_DIR=build
set OUT=%OUT_DIR%\xui_hyperlink.exe
set SRC=examples\xui_hyperlink\main.c src\xui_core.c src\xui_widget.c src\xui_input.c src\xui_text.c src\xui_label.c src\xui_hyperlink.c src\xui_proxy_xge.c
set INC=-I.
...
echo [XUI] Building xui_hyperlink...
