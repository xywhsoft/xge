...
set SRC=examples\xui_tabs\main.c src\xui_core.c src\xui_widget.c src\xui_input.c src\xui_text.c src\xui_label.c src\xui_popup.c src\xui_menu.c src\xui_tabs.c src\xui_proxy_xge.c
set INC=-I.
