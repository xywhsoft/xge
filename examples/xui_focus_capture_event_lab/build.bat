...
set OUT_DIR=build
set OUT=%OUT_DIR%\xge_xui_focus_capture_event_lab.exe
set SRC=xge.c examples\xui_focus_capture_event_lab\main.c
set INC=-I.
...
echo [XGE] Building xui focus capture event lab EXE...
