...
set OUT_DIR=build
set OUT=%OUT_DIR%\xui_timelineview.exe
set SRC=examples\xui_timelineview\main.c src\xui_core.c src\xui_widget.c src\xui_input.c src\xui_text.c src\xui_label.c src\xui_scroll_model.c src\xui_scrollbar.c src\xui_scroll_frame.c src\xui_scroll_view.c src\xui_popup.c src\xui_menu.c src\xui_timeline_view.c src\xui_proxy_xge.c
set INC=-I.
...
echo [XUI] Building xui_timelineview...
