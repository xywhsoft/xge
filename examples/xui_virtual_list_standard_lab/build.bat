...
set OUT_DIR=build
set OUT=%OUT_DIR%\xge_xui_virtual_list_standard_lab.exe
set SRC=examples\xui_virtual_list_standard_lab\main.c
set INC=-I.
...
echo [XGE] Building xui virtual list standard lab EXE...
