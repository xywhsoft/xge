...
set OUT_DIR=build
set OUT=%OUT_DIR%\xui_propertygrid_xson.exe
set SRC=examples\xui_propertygrid_xson\main.c
set INC=-I.
...
set LIBS=%XGE_LIB% -lws2_32 -liphlpapi -lgdi32 -luser32 -lshell32 -lopengl32 -lwinmm -lavrt
...
echo [XGE] Building xui_propertygrid_xson EXE...
