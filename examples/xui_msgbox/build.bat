...
set OUT_DIR=build
set OUT=%OUT_DIR%\xui_msgbox.exe
set SRC=examples\xui_msgbox\main.c src\xui_core.c src\xui_widget.c src\xui_input.c src\xui_text.c src\xui_assets.c src\xui_button.c src\xui_window.c src\xui_msgbox.c src\xui_proxy_xge.c
set INC=-I.
