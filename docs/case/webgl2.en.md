...
> English translation for the XGE case document `docs/case/webgl2.md`.

[Chinese Source](webgl2.md)

## Purpose

This document explains webgl2 for XGE users. It follows the same scope and support status as the Chinese source document.
