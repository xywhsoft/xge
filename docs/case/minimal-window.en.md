...
> English translation for the XGE case document `docs/case/minimal-window.md`.

[Chinese Source](minimal-window.md)

## Purpose

This document explains minimal window for XGE users. It follows the same scope and support status as the Chinese source document.
