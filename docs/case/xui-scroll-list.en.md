...
> English translation for the XGE case document `docs/case/xui-scroll-list.md`.

[Chinese Source](xui-scroll-list.md)

## Purpose

This document explains xui scroll list for XGE users. It follows the same scope and support status as the Chinese source document.
