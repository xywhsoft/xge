...
> English translation for the XGE case document `docs/case/text-input.md`.

[Chinese Source](text-input.md)

## Purpose

This document explains text input for XGE users. It follows the same scope and support status as the Chinese source document.
