...
> English translation for the XGE case document `docs/case/miniprogram-hello.md`.

[Chinese Source](miniprogram-hello.md)

## Purpose

This document explains miniprogram hello for XGE users. It follows the same scope and support status as the Chinese source document.
