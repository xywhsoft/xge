...
> English translation for the XGE case document `docs/case/macos.md`.

[Chinese Source](macos.md)

## Purpose

This document explains macos for XGE users. It follows the same scope and support status as the Chinese source document.
