...
> English translation for the XGE case document `docs/case/android-apk.md`.

[Chinese Source](android-apk.md)

## Purpose

This document explains android apk for XGE users. It follows the same scope and support status as the Chinese source document.
