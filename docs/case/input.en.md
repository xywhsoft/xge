...
> English translation for the XGE case document `docs/case/input.md`.

[Chinese Source](input.md)

## Purpose

This document explains input for XGE users. It follows the same scope and support status as the Chinese source document.
