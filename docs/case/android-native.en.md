...
> English translation for the XGE case document `docs/case/android-native.md`.

[Chinese Source](android-native.md)

## Purpose

This document explains android native for XGE users. It follows the same scope and support status as the Chinese source document.
