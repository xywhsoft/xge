...
> English translation for the XGE case document `docs/case/xui-form.md`.

[Chinese Source](xui-form.md)

## Purpose

This document explains xui form for XGE users. It follows the same scope and support status as the Chinese source document.
