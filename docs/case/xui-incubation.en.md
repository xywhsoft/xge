...
> English translation for the XGE case document `docs/case/xui-incubation.md`.

[Chinese Source](xui-incubation.md)

## Purpose

This document explains xui incubation for XGE users. It follows the same scope and support status as the Chinese source document.
