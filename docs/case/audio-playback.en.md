...
> English translation for the XGE case document `docs/case/audio-playback.md`.

[Chinese Source](audio-playback.md)

## Purpose

This document explains audio playback for XGE users. It follows the same scope and support status as the Chinese source document.
