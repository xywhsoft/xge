...
> English translation for the XGE case document `docs/case/async-loading.md`.

[Chinese Source](async-loading.md)

## Purpose

This document explains async loading for XGE users. It follows the same scope and support status as the Chinese source document.
