...
> English translation for the XGE case document `docs/case/shader-distortion.md`.

[Chinese Source](shader-distortion.md)

## Purpose

This document explains shader distortion for XGE users. It follows the same scope and support status as the Chinese source document.
