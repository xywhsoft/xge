...
> English translation for the XGE case document `docs/case/scene-stack.md`.

[Chinese Source](scene-stack.md)

## Purpose

This document explains scene stack for XGE users. It follows the same scope and support status as the Chinese source document.
