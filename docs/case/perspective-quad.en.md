...
> English translation for the XGE case document `docs/case/perspective-quad.md`.

[Chinese Source](perspective-quad.md)

## Purpose

This document explains perspective quad for XGE users. It follows the same scope and support status as the Chinese source document.
