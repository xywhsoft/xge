...
> English translation for the XGE case document `docs/case/xui-bridge.md`.

[Chinese Source](xui-bridge.md)

## Purpose

This document explains xui bridge for XGE users. It follows the same scope and support status as the Chinese source document.
