...
> English translation for the XGE case document `docs/case/xui-dialog.md`.

[Chinese Source](xui-dialog.md)

## Purpose

This document explains xui dialog for XGE users. It follows the same scope and support status as the Chinese source document.
