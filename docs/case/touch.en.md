...
> English translation for the XGE case document `docs/case/touch.md`.

[Chinese Source](touch.md)

## Purpose

This document explains touch for XGE users. It follows the same scope and support status as the Chinese source document.
