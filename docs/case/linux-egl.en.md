...
> English translation for the XGE case document `docs/case/linux-egl.md`.

[Chinese Source](linux-egl.md)

## Purpose

This document explains linux egl for XGE users. It follows the same scope and support status as the Chinese source document.
