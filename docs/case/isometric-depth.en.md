...
> English translation for the XGE case document `docs/case/isometric-depth.md`.

[Chinese Source](isometric-depth.md)

## Purpose

This document explains isometric depth for XGE users. It follows the same scope and support status as the Chinese source document.
