...
> English translation for the XGE case document `docs/case/linux-x11.md`.

[Chinese Source](linux-x11.md)

## Purpose

This document explains linux x11 for XGE users. It follows the same scope and support status as the Chinese source document.
