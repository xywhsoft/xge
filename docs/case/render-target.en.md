...
> English translation for the XGE case document `docs/case/render-target.md`.

[Chinese Source](render-target.md)

## Purpose

This document explains render target for XGE users. It follows the same scope and support status as the Chinese source document.
