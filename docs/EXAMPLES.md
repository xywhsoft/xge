...
| XUI Basic Controls Lab | `examples/xui_basic_controls_lab` | `examples\xui_basic_controls_lab\build.bat` | Label/Image/Button/IconButton/Panel/Separator 的 setter 和 state 自检 |
...
| XUI Value Controls Lab | `examples/xui_value_controls_lab` | `examples\xui_value_controls_lab\build.bat` | Slider/Progress/Splitter/ScrollBar 的 range/page/value/orientation/state 自检 |
...
| XUI Overlay Menu Lab | `examples/xui_overlay_menu_lab` | `examples\xui_overlay_menu_lab\build.bat` | Popup/Tooltip/ComboBox/Menu/Dialog、modal/outside close/ESC close 和 disabled item 自检 |
...
| XUI Visual Proc Lab | `examples/xui_visual_proc_lab` | `examples\xui_visual_proc_lab\build.bat` | Label/Image/Button/IconButton/Separator/Panel 的 procMeasure/procPaint/procEvent 自检 |
| XUI Control Proc Lab | `examples/xui_control_proc_lab` | `examples\xui_control_proc_lab\build.bat` | Toggle/CheckBox/Radio/Switch/Slider/ScrollBar/Splitter/Progress 的 EventProc/PaintProc 自检 |
| XUI Overlay Proc Lab | `examples/xui_overlay_proc_lab` | `examples\xui_overlay_proc_lab\build.bat` | Popup/ComboBox/Dialog 以及 combo 内部 ListView 的 Event/EventProc/PaintProc 自检 |
...
| XUI Button State Lab | `examples/xui_button_state_lab` | `examples\xui_button_state_lab\build.bat` | Button/IconButton 的 hover、active、focus、disabled、capture 和 keyboard click 状态自检 |
...
| XUI Combo Detail Lab | `examples/xui_combo_detail_lab` | `examples\xui_combo_detail_lab\build.bat` | ComboBox 的 selected/open/state、disabled row、dropdown height 和 keyboard open 自检 |
...
| XUI Menu Owner Lab | `examples/xui_menu_owner_lab` | `examples\xui_menu_owner_lab\build.bat` | Menu 的 owner 绑定、SetItems/SetEnabledItems/SetSize/SetColors、disabled row、outside close 和 focus return 自检 |
| XUI Menu Policy Lab | `examples/xui_menu_policy_lab` | `examples\xui_menu_policy_lab\build.bat` | Menu 的 open reset、重复 reopen、size update、clamp、focus return 和 close 幂等自检 |
...
| XUI Tooltip Policy Lab | `examples/xui_tooltip_policy_lab` | `examples\xui_tooltip_policy_lab\build.bat` | Tooltip 的 SetOpen 门控、live text/offset relayout、owner event open-close 和 legacy capture 自检 |
| XUI Tooltip Owner Lab | `examples/xui_tooltip_owner_lab` | `examples\xui_tooltip_owner_lab\build.bat` | Tooltip 的 owner capture 链、SetText/SetOffset/SetEnabled/SetOpen 和 OwnerEventProc 自检 |
| XUI Dialog Policy Lab | `examples/xui_dialog_policy_lab` | `examples\xui_dialog_policy_lab\build.bat` | Dialog 的 modal/non-modal、closeOnEscape、showClose、event consumption 和 reopen 自检 |
| XUI Dialog Modal Lab | `examples/xui_dialog_modal_lab` | `examples\xui_dialog_modal_lab\build.bat` | Dialog 的 SetTitle/SetModal/SetCloseOnEscape/SetShowClose/SetColors、close button、ESC 和 modal block 自检 |
...
| Game Login Lab | `examples/game_login_lab` | `examples\game_login_lab\build.bat` | 登录面板、password input、preset menu、failure dialog 和 scene switch 综合自检 |
