...
| Controls | `xgeXuiButton*`、`xgeXuiLabel*`、`xgeXuiImage*`、`xgeXuiInput*`、`xgeXuiSlider*`、`xgeXuiProgress*`、`xgeXuiPanel*`、`xgeXuiScrollView*`、`xgeXuiPopup*`、`xgeXuiDialog*`、`xgeXuiNumericInput*`、`xgeXuiDatePicker*`、`xgeXuiMessageBox*`、`xgeXuiToolbar*`、`xgeXuiStatusBar*`、`xgeXuiBreadcrumb*`、`xgeXuiAccordion*`、`xgeXuiToast*` |
| Quarantined Viewport Controls | `xgeXuiListView*`、`xgeXuiVirtualList*`、`xgeXuiTreeView*`、`xgeXuiTableView*`、`xgeXuiPropertyGrid*`、`xgeXuiMenu*`、`xgeXuiComboBox*`、`xgeXuiColorPicker*`、`xgeXuiTextEdit*` |
...
TreeView、TableView、PropertyGrid 旧实现当前被隔离。恢复时必须复用 VirtualView 和 ScrollFrame，不能继续保留旧 `virtual_scroll_view_base` 口径。
