...
> English translation for the XGE guide document `docs/guide/render-thread-intro.md`.

[Chinese Source](render-thread-intro.md)

## Purpose

This document explains render thread intro for XGE users. It follows the same scope and support status as the Chinese source document.
