...
> English translation for the XGE guide document `docs/guide/render-target-intro.md`.

[Chinese Source](render-target-intro.md)

## Purpose

This document explains render target intro for XGE users. It follows the same scope and support status as the Chinese source document.
