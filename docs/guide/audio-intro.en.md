...
> English translation for the XGE guide document `docs/guide/audio-intro.md`.

[Chinese Source](audio-intro.md)

## Purpose

This document explains audio intro for XGE users. It follows the same scope and support status as the Chinese source document.
