...
> English translation for the XGE guide document `docs/guide/texture-intro.md`.

[Chinese Source](texture-intro.md)

## Purpose

This document explains texture intro for XGE users. It follows the same scope and support status as the Chinese source document.
