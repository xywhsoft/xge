...
> English translation for the XGE guide document `docs/guide/first-xge-program.md`.

[Chinese Source](first-xge-program.md)

## Purpose

This document explains first xge program for XGE users. It follows the same scope and support status as the Chinese source document.
