...
> English translation for the XGE guide document `docs/guide/ios-macos-intro.md`.

[Chinese Source](ios-macos-intro.md)

## Purpose

This document explains ios macos intro for XGE users. It follows the same scope and support status as the Chinese source document.
