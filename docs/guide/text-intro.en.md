...
> English translation for the XGE guide document `docs/guide/text-intro.md`.

[Chinese Source](text-intro.md)

## Purpose

This document explains text intro for XGE users. It follows the same scope and support status as the Chinese source document.
