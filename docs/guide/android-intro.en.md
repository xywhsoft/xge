...
> English translation for the XGE guide document `docs/guide/android-intro.md`.

[Chinese Source](android-intro.md)

## Purpose

This document explains android intro for XGE users. It follows the same scope and support status as the Chinese source document.
