...
> English translation for the XGE guide document `docs/guide/input-intro.md`.

[Chinese Source](input-intro.md)

## Purpose

This document explains input intro for XGE users. It follows the same scope and support status as the Chinese source document.
