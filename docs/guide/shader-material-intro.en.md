# Shader Material Intro

> English translation for the XGE guide document `docs/guide/shader-material-intro.md`.

[Chinese Source](shader-material-intro.md)

## Purpose

This document explains shader material intro for XGE users. It follows the same scope and support status as the Chinese source document.
