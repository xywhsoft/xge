...
> English translation for the XGE guide document `docs/guide/blend-alpha-intro.md`.

[Chinese Source](blend-alpha-intro.md)

## Purpose

This document explains blend alpha intro for XGE users. It follows the same scope and support status as the Chinese source document.
