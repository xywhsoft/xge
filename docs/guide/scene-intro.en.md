...
> English translation for the XGE guide document `docs/guide/scene-intro.md`.

[Chinese Source](scene-intro.md)

## Purpose

This document explains scene intro for XGE users. It follows the same scope and support status as the Chinese source document.
