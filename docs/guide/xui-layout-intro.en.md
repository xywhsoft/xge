...
> English translation for the XGE guide document `docs/guide/xui-layout-intro.md`.

[Chinese Source](xui-layout-intro.md)

## Purpose

This document explains xui layout intro for XGE users. It follows the same scope and support status as the Chinese source document.
