...
> English translation for the XGE guide document `docs/guide/drawing-intro.md`.

[Chinese Source](drawing-intro.md)

## Purpose

This document explains drawing intro for XGE users. It follows the same scope and support status as the Chinese source document.
