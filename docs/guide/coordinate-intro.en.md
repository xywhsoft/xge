...
> English translation for the XGE guide document `docs/guide/coordinate-intro.md`.

[Chinese Source](coordinate-intro.md)

## Purpose

This document explains coordinate intro for XGE users. It follows the same scope and support status as the Chinese source document.
