...
- Overlays: structural overlay pages keep nodes such as `popup/menu`; `tooltip` is a widget property; `msgTip/msgBox/inputBox/toast` are C API convenience services and are not the new XSON page-node direction.
