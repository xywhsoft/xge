# Migration from XGE V1

> English translation for the XGE topic document `docs/MIGRATION.md`.

[Chinese Source](MIGRATION.md)

## Purpose

This document explains migration from xge v1 for XGE users. It follows the same scope and support status as the Chinese source document.
