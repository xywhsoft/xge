...
> English translation for the XGE topic document `docs/BEST_PRACTICES.md`.

[Chinese Source](BEST_PRACTICES.md)

## Purpose

This document explains best practices for XGE users. It follows the same scope and support status as the Chinese source document.
