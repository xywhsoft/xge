...
set OUT_DIR=build
set OUT=%OUT_DIR%\xui_toast.exe
set SRC=examples\xui_toast\main.c src\xui_core.c src\xui_widget.c src\xui_input.c src\xui_text.c src\xui_assets.c src\xui_button.c src\xui_toast.c src\xui_proxy_xge.c
set INC=-I.
