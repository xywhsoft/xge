...
set OUT_DIR=build
set OUT=%OUT_DIR%\xui_chart.exe
set SRC=examples\xui_chart\main.c src\xui_core.c src\xui_widget.c src\xui_input.c src\xui_chart.c src\xui_proxy_xge.c
set INC=-I.
