...
set SRC=examples\xui_dockpanel\main.c src\xui_core.c src\xui_widget.c src\xui_input.c src\xui_text.c src\xui_label.c src\xui_assets.c src\xui_scroll_model.c src\xui_scrollbar.c src\xui_scroll_frame.c src\xui_scroll_view.c src\xui_popup.c src\xui_menu.c src\xui_dock_panel.c src\xui_proxy_xge.c
set INC=-I.
...
echo [XUI] Building xui_dockpanel...
