...
set OUT_DIR=build
set OUT=%OUT_DIR%\xui_popup.exe
set SRC=examples\xui_popup\main.c src\xui_core.c src\xui_widget.c src\xui_input.c src\xui_text.c src\xui_label.c src\xui_button.c src\xui_scroll_model.c src\xui_scrollbar.c src\xui_scroll_frame.c src\xui_scroll_view.c src\xui_popup.c src\xui_proxy_xge.c
set INC=-I.
