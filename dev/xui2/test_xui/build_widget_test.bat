...
set SRC=test_xui\xui_widget_test.c test_xui\xui_test_proxy.c src\xui_core.c src\xui_widget.c src\xui_input.c src\xui_proxy_xge.c
set INC=-I.
...
echo [XUI] Building xui_widget_test...
