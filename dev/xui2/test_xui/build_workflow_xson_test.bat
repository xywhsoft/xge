...
set OUT_DIR=build
set OUT=%OUT_DIR%\xui_workflow_xson_test.exe
set SRC=test_xui\xui_workflow_xson_test.c src\xui_flow_graph.c src\xui_workflow.c
set INC=-I.
...
echo [XUI] Building xui_workflow_xson_test...
