...
set SRC=test_xui\xui_message_list_test.c test_xui\xui_test_proxy.c src\xui_core.c src\xui_widget.c src\xui_input.c src\xui_text.c src\xui_message_list.c
set INC=-I.
