...
set OUT_DIR=build
set OUT=%OUT_DIR%\xui_code_layout_test.exe
set SRC=test_xui\xui_code_layout_test.c src\xui_code_document.c src\xui_code_fold.c src\xui_code_layout.c
set INC=-I.
...
echo [XUI] Building xui_code_layout_test...
