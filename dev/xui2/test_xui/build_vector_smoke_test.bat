...
set OUT_DIR=build
set OUT=%OUT_DIR%\xui_vector_smoke_test.exe
set SRC=test_xui\xui_vector_smoke_test.c test_xui\xui_test_proxy.c src\xui_core.c src\xui_widget.c src\xui_input.c
set INC=-I.
...
echo [XUI] Building xui_vector_smoke_test...
