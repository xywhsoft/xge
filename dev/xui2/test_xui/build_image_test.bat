...
set OUT_DIR=build
set OUT=%OUT_DIR%\xui_image_test.exe
set SRC=test_xui\xui_image_test.c src\xui_core.c src\xui_widget.c src\xui_input.c src\xui_image.c
set INC=-I.
...
echo [XUI] Building xui_image_test...
