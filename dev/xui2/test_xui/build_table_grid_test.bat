...
set OUT_DIR=build
set OUT=%OUT_DIR%\xui_table_grid_test.exe
set SRC=test_xui\xui_table_grid_test.c test_xui\xui_test_proxy.c src\xui_core.c src\xui_widget.c src\xui_input.c src\xui_text.c src\xui_assets.c src\xui_button.c src\xui_scroll_model.c src\xui_scrollbar.c src\xui_scroll_frame.c src\xui_scroll_view.c src\xui_popup.c src\xui_menu.c src\xui_input_widget.c src\xui_numeric_input.c src\xui_combobox.c src\xui_color_picker.c src\xui_date_picker.c src\xui_find.c src\xui_text_edit.c src\xui_table_view.c src\xui_table_grid.c
set INC=-I.
...
echo [XUI] Building xui_table_grid_test...
