...
set OUT_DIR=build
set OUT=%OUT_DIR%\xui_code_annotation_test.exe
set SRC=test_xui\xui_code_annotation_test.c src\xui_code_annotation.c
set INC=-I.
...
echo [XUI] Building xui_code_annotation_test...
