...
int main(void)
{
	...
	iRet = xuiInputPointerMove(pContext, 310.0f, 100.0f, 0);
	...
	iRet = xuiInputPointerMove(pContext, 243.0f, 122.0f, 0);
	...
	iRet = xuiInputPointerMove(pContext, 20.0f, 20.0f, 0);
