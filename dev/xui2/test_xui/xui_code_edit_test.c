...
int main(void)
{
	...
	iRet = __xuiCodeEditPointerDown(pContext, 20.0f + fTextOriginX + 4.0f + 8.0f * 2.0f, 30.0f + 9.0f);
	...
	iRet = __xuiCodeEditPointerMove(pContext, 20.0f + fTextOriginX + 4.0f + 8.0f * 5.0f, 30.0f + 9.0f);
	...
	iRet = __xuiCodeEditPointerUp(pContext, 20.0f + fTextOriginX + 4.0f + 8.0f * 5.0f, 30.0f + 9.0f);
	XUI_TEST_CHECK(iRet == XUI_OK && xuiGetPointerCapture(pContext) == NULL, "pointer up releases capture");
	iRet = __xuiCodeEditDoubleClick(pContext, 20.0f + fTextOriginX + 4.0f + 8.0f * 2.0f, 30.0f + 9.0f, 0u);
