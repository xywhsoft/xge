...
> English translation for the XGE topic document `docs/ARCHITECTURE.md`.

[Chinese Source](ARCHITECTURE.md)

## Purpose

This document explains architecture for XGE users. It follows the same scope and support status as the Chinese source document.
