...
> English translation for the XGE topic document `docs/EXAMPLES.md`.

[Chinese Source](EXAMPLES.md)

## Purpose

This document explains examples for XGE users. It follows the same scope and support status as the Chinese source document.
