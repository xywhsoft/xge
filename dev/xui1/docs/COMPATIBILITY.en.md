...
> English translation for the XGE topic document `docs/COMPATIBILITY.md`.

[Chinese Source](COMPATIBILITY.md)

## Purpose

This document explains compatibility for XGE users. It follows the same scope and support status as the Chinese source document.
