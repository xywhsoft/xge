...
> English translation for the XGE topic document `docs/PERFORMANCE.md`.

[Chinese Source](PERFORMANCE.md)

## Purpose

This document explains performance for XGE users. It follows the same scope and support status as the Chinese source document.
