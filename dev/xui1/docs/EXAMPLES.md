...
| XUI Choice Controls Lab | `examples/xui_choice_controls_lab` | `examples\xui_choice_controls_lab\build.bat` | Toggle/CheckBox/RadioGroup/Radio 的 getter、state 和交互自检 |
...
| Game Login Lab | `examples/game_login_lab` | `examples\game_login_lab\build.bat` | 登录面板、password input、preset menu、failure MsgBox 和 scene transition 综合自检 |
