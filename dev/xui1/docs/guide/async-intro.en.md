...
> English translation for the XGE guide document `docs/guide/async-intro.md`.

[Chinese Source](async-intro.md)

## Purpose

This document explains async intro for XGE users. It follows the same scope and support status as the Chinese source document.
