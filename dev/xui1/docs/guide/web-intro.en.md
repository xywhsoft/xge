...
> English translation for the XGE guide document `docs/guide/web-intro.md`.

[Chinese Source](web-intro.md)

## Purpose

This document explains web intro for XGE users. It follows the same scope and support status as the Chinese source document.
