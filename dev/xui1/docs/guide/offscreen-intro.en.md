...
> English translation for the XGE guide document `docs/guide/offscreen-intro.md`.

[Chinese Source](offscreen-intro.md)

## Purpose

This document explains offscreen intro for XGE users. It follows the same scope and support status as the Chinese source document.
