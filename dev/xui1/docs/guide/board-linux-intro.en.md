...
> English translation for the XGE guide document `docs/guide/board-linux-intro.md`.

[Chinese Source](board-linux-intro.md)

## Purpose

This document explains board linux intro for XGE users. It follows the same scope and support status as the Chinese source document.
