...
> English translation for the XGE guide document `docs/guide/miniprogram-intro.md`.

[Chinese Source](miniprogram-intro.md)

## Purpose

This document explains miniprogram intro for XGE users. It follows the same scope and support status as the Chinese source document.
