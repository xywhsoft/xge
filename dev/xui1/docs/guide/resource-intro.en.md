...
> English translation for the XGE guide document `docs/guide/resource-intro.md`.

[Chinese Source](resource-intro.md)

## Purpose

This document explains resource intro for XGE users. It follows the same scope and support status as the Chinese source document.
