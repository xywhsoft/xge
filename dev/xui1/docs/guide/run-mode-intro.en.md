...
> English translation for the XGE guide document `docs/guide/run-mode-intro.md`.

[Chinese Source](run-mode-intro.md)

## Purpose

This document explains run mode intro for XGE users. It follows the same scope and support status as the Chinese source document.
