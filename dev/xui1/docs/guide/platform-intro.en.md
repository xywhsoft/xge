...
> English translation for the XGE guide document `docs/guide/platform-intro.md`.

[Chinese Source](platform-intro.md)

## Purpose

This document explains platform intro for XGE users. It follows the same scope and support status as the Chinese source document.
