...
> English translation for the XGE guide document `docs/guide/error-and-log.md`.

[Chinese Source](error-and-log.md)

## Purpose

This document explains error and log for XGE users. It follows the same scope and support status as the Chinese source document.
