...
> English translation for the XGE guide document `docs/guide/project-structure.md`.

[Chinese Source](project-structure.md)

## Purpose

This document explains project structure for XGE users. It follows the same scope and support status as the Chinese source document.
