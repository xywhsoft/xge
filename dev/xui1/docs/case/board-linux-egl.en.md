...
> English translation for the XGE case document `docs/case/board-linux-egl.md`.

[Chinese Source](board-linux-egl.md)

## Purpose

This document explains board linux egl for XGE users. It follows the same scope and support status as the Chinese source document.
