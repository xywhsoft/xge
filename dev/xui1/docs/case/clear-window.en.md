...
> English translation for the XGE case document `docs/case/clear-window.md`.

[Chinese Source](clear-window.md)

## Purpose

This document explains clear window for XGE users. It follows the same scope and support status as the Chinese source document.
