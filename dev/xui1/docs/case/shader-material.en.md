...
> English translation for the XGE case document `docs/case/shader-material.md`.

[Chinese Source](shader-material.md)

## Purpose

This document explains shader material for XGE users. It follows the same scope and support status as the Chinese source document.
