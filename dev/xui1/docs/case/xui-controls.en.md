...
> English translation for the XGE case document `docs/case/xui-controls.md`.

[Chinese Source](xui-controls.md)

## Purpose

This document explains xui controls for XGE users. It follows the same scope and support status as the Chinese source document.
