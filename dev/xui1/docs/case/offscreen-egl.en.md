...
> English translation for the XGE case document `docs/case/offscreen-egl.md`.

[Chinese Source](offscreen-egl.md)

## Purpose

This document explains offscreen egl for XGE users. It follows the same scope and support status as the Chinese source document.
