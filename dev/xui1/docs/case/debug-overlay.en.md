...
> English translation for the XGE case document `docs/case/debug-overlay.md`.

[Chinese Source](debug-overlay.md)

## Purpose

This document explains debug overlay for XGE users. It follows the same scope and support status as the Chinese source document.
