...
> English translation for the XGE case document `docs/case/platform-smoke.md`.

[Chinese Source](platform-smoke.md)

## Purpose

This document explains platform smoke for XGE users. It follows the same scope and support status as the Chinese source document.
