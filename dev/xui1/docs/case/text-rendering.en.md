...
> English translation for the XGE case document `docs/case/text-rendering.md`.

[Chinese Source](text-rendering.md)

## Purpose

This document explains text rendering for XGE users. It follows the same scope and support status as the Chinese source document.
