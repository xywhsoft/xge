...
> English translation for the XGE case document `docs/case/texture-sprite.md`.

[Chinese Source](texture-sprite.md)

## Purpose

This document explains texture sprite for XGE users. It follows the same scope and support status as the Chinese source document.
