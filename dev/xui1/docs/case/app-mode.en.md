...
> English translation for the XGE case document `docs/case/app-mode.md`.

[Chinese Source](app-mode.md)

## Purpose

This document explains app mode for XGE users. It follows the same scope and support status as the Chinese source document.
