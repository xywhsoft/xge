...
> English translation for the XGE case document `docs/case/sprite-batch.md`.

[Chinese Source](sprite-batch.md)

## Purpose

This document explains sprite batch for XGE users. It follows the same scope and support status as the Chinese source document.
