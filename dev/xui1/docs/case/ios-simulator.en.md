...
> English translation for the XGE case document `docs/case/ios-simulator.md`.

[Chinese Source](ios-simulator.md)

## Purpose

This document explains ios simulator for XGE users. It follows the same scope and support status as the Chinese source document.
