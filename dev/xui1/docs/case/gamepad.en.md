...
> English translation for the XGE case document `docs/case/gamepad.md`.

[Chinese Source](gamepad.md)

## Purpose

This document explains gamepad for XGE users. It follows the same scope and support status as the Chinese source document.
