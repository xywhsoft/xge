...
> English translation for the XGE topic document `docs/STATUS.md`.

[Chinese Source](STATUS.md)

## Purpose

This document explains status for XGE users. It follows the same scope and support status as the Chinese source document.
