...
set OUT_DIR=build
set OUT=%OUT_DIR%\xge_xui_dockpanel_smoke.exe
set SRC=test\xui_dockpanel_smoke.c
set INC=-I.
...
call build_dll.bat || (popd && exit /b 1)

echo [XGE] Building xui_dockpanel_smoke EXE...
