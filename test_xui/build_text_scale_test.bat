@echo off
setlocal
set OUT=build\xui_text_scale_test.exe
...
gcc %FLAGS% -I. -Wl,--gc-sections -o %OUT% test_xui\xui_text_scale_test.c build\xge.lib -lm -lws2_32 -liphlpapi -lgdi32 -luser32 -lshell32 -lole32 -lwinmm -lavrt
if errorlevel 1 exit /b %errorlevel%
%OUT% %*
if errorlevel 1 exit /b %errorlevel%
endlocal
