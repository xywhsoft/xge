...
set OUT_DIR=build
set OUT=%OUT_DIR%\xui_flow_graph_scale_test.exe
set SRC=test_xui\xui_flow_graph_scale_test.c src\xui_flow_graph.c
set INC=-I.
...
echo [XUI] Building xui_flow_graph_scale_test...
