...
set OUT_DIR=build
set OUT=%OUT_DIR%\xui_code_token_buffer_test.exe
set SRC=test_xui\xui_code_token_buffer_test.c src\xui_code_token_buffer.c
set INC=-I.
...
echo [XUI] Building xui_code_token_buffer_test...
