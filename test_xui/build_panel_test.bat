...
set OUT_DIR=build
set OUT=%OUT_DIR%\xui_panel_test.exe
set SRC=test_xui\xui_panel_test.c test_xui\xui_test_proxy.c src\xui_core.c src\xui_widget.c src\xui_input.c src\xui_text.c src\xui_label.c src\xui_image.c src\xui_panel.c
set INC=-I.
...
echo [XUI] Building xui_panel_test...
