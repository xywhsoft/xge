...
set OUT_DIR=build
set OUT=%OUT_DIR%\xui_code_fold_test.exe
set SRC=test_xui\xui_code_fold_test.c src\xui_code_document.c src\xui_code_fold.c
set INC=-I.
...
echo [XUI] Building xui_code_fold_test...
