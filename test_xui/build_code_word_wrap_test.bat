...
set OUT_DIR=build
set OUT=%OUT_DIR%\xui_code_word_wrap_test.exe
set SRC=test_xui\xui_code_word_wrap_test.c test_xui\xui_test_proxy.c src\xui_unicode.c
set INC=-I.
...
%OUT%
if %errorlevel% neq 0 exit /b 1
echo [XUI] Code word wrap test passed: %OUT%
endlocal
