...
set OUT_DIR=build
set OUT=%OUT_DIR%\xui_check_card_test.exe
set SRC=test_xui\xui_check_card_test.c test_xui\xui_test_proxy.c src\xui_core.c src\xui_widget.c src\xui_input.c src\xui_text.c src\xui_label.c src\xui_check_card.c src\xui_radio.c
set INC=-I.
...
echo [XUI] Building xui_check_card_test...
