...
static int gColorCount, gMeasures;
...
static void collectionRecord(uint32_t c) { if ((c & 255u) && gColorCount < COUNT(gColors)) gColors[gColorCount++] = c; }
