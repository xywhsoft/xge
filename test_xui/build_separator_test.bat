...
set OUT_DIR=build
set OUT=%OUT_DIR%\xui_separator_test.exe
set SRC=test_xui\xui_separator_test.c test_xui\xui_test_proxy.c src\xui_core.c src\xui_widget.c src\xui_input.c src\xui_separator.c
set INC=-I.
...
echo [XUI] Building xui_separator_test...
