...
set SRC=test_xui\xui_text_edit_display_test.c test_xui\xui_test_proxy.c test_xui\xui_test_xrt_impl.c lib\xlayout\xlayout.c
...
gcc -O1 -g -Wall -Wextra -Wno-unused-parameter -Wno-unused-function -Wno-cast-function-type -DXGE_DEBUGMODE=0 -I. -o build\xui_text_edit_display_test.exe %SRC% -Wl,--wrap=xrtMalloc -lm -lws2_32 -liphlpapi -lgdi32 -luser32 -lshell32 -lopengl32 -lole32 -lwinmm -lavrt
if errorlevel 1 exit /b %errorlevel%
build\xui_text_edit_display_test.exe %*
exit /b %errorlevel%
