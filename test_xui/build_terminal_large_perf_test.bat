...
set OUT_DIR=build
set OUT=%OUT_DIR%\xui_terminal_large_perf_test.exe
set SRC=test_xui\xui_terminal_large_perf_test.c test_xui\xui_test_proxy.c
set INC=-I.
...
echo [XUI] Building xui_terminal_large_perf_test...
