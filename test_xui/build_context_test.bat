...
set OUT_DIR=build
set OUT=%OUT_DIR%\xui_context_test.exe
set SRC=test_xui\xui_context_test.c src\xui_core.c src\xui_widget.c src\xui_input.c src\xui_proxy_xge.c
set INC=-I.
...
echo [XUI] Building xui_context_test...
