...
set OUT_DIR=build
set OUT=%OUT_DIR%\xui_code_editing_test.exe
set SRC=test_xui\xui_code_editing_test.c src\xui_code_document.c src\xui_code_selection.c src\xui_code_editing.c
set INC=-I.
...
echo [XUI] Building xui_code_editing_test...
