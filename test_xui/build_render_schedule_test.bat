...
set OUT_DIR=build
set OUT=%OUT_DIR%\xui_render_schedule_test.exe
set SRC=test_xui\xui_render_schedule_test.c src\xui_core.c src\xui_widget.c src\xui_input.c
set INC=-I.
...
echo [XUI] Building xui_render_schedule_test...
