...
set XUI_SRC=src\xui_core.c src\xui_widget.c src\xui_input.c src\xui_icon.c src\xui_assets.c src\xui_builtin_atlas.c src\xui_text.c src\xui_label.c src\xui_scroll_model.c src\xui_scrollbar.c src\xui_scroll_frame.c src\xui_scroll_view.c src\xui_canvas.c src\xui_popup.c src\xui_menu.c src\xui_menubar.c src\xui_toolbar.c src\xui_statusbar.c src\xui_dock_panel.c src\xui_proxy_xge.c
