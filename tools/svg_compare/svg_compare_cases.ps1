function Get-XgeSvgCompareCases {
	...
	$cases = @(
		...
		[ordered]@{ name = "root_aspect_none_wide"; svg = "examples\xge_svg\assets\root_aspect_none_wide.svg"; tags = @("root-aspect-batch-147", "viewport", "preserve", "none"); xge_preserve_aspect_ratio = "document" },
		[ordered]@{ name = "root_aspect_meet_y_min"; svg = "examples\xge_svg\assets\root_aspect_meet_y_min.svg"; tags = @("root-aspect-batch-147", "viewport", "preserve", "meet"); xge_preserve_aspect_ratio = "document" },
		[ordered]@{ name = "root_aspect_meet_y_mid"; svg = "examples\xge_svg\assets\root_aspect_meet_y_mid.svg"; tags = @("root-aspect-batch-147", "viewport", "preserve", "meet"); xge_preserve_aspect_ratio = "document" },
		[ordered]@{ name = "root_aspect_meet_y_max"; svg = "examples\xge_svg\assets\root_aspect_meet_y_max.svg"; tags = @("root-aspect-batch-147", "viewport", "preserve", "meet"); xge_preserve_aspect_ratio = "document" },
		[ordered]@{ name = "root_aspect_slice_x_min"; svg = "examples\xge_svg\assets\root_aspect_slice_x_min.svg"; tags = @("root-aspect-batch-147", "viewport", "preserve", "slice"); xge_preserve_aspect_ratio = "document" },
		[ordered]@{ name = "root_aspect_slice_x_mid"; svg = "examples\xge_svg\assets\root_aspect_slice_x_mid.svg"; tags = @("root-aspect-batch-147", "viewport", "preserve", "slice"); xge_preserve_aspect_ratio = "document" },
		[ordered]@{ name = "root_aspect_slice_x_max"; svg = "examples\xge_svg\assets\root_aspect_slice_x_max.svg"; tags = @("root-aspect-batch-147", "viewport", "preserve", "slice"); xge_preserve_aspect_ratio = "document" },
		[ordered]@{ name = "root_aspect_meet_x_min"; svg = "examples\xge_svg\assets\root_aspect_meet_x_min.svg"; tags = @("root-aspect-batch-147", "viewport", "preserve", "meet"); xge_preserve_aspect_ratio = "document" },
		[ordered]@{ name = "root_aspect_meet_x_mid"; svg = "examples\xge_svg\assets\root_aspect_meet_x_mid.svg"; tags = @("root-aspect-batch-147", "viewport", "preserve", "meet"); xge_preserve_aspect_ratio = "document" },
		[ordered]@{ name = "root_aspect_meet_x_max"; svg = "examples\xge_svg\assets\root_aspect_meet_x_max.svg"; tags = @("root-aspect-batch-147", "viewport", "preserve", "meet"); xge_preserve_aspect_ratio = "document" },
		[ordered]@{ name = "root_aspect_slice_y_min"; svg = "examples\xge_svg\assets\root_aspect_slice_y_min.svg"; tags = @("root-aspect-batch-147", "viewport", "preserve", "slice"); xge_preserve_aspect_ratio = "document" },
		[ordered]@{ name = "root_aspect_slice_y_mid"; svg = "examples\xge_svg\assets\root_aspect_slice_y_mid.svg"; tags = @("root-aspect-batch-147", "viewport", "preserve", "slice"); xge_preserve_aspect_ratio = "document" },
		[ordered]@{ name = "root_aspect_slice_y_max"; svg = "examples\xge_svg\assets\root_aspect_slice_y_max.svg"; tags = @("root-aspect-batch-147", "viewport", "preserve", "slice"); xge_preserve_aspect_ratio = "document" },
		[ordered]@{ name = "root_aspect_default_wide"; svg = "examples\xge_svg\assets\root_aspect_default_wide.svg"; tags = @("root-aspect-batch-147", "viewport", "preserve", "default"); xge_preserve_aspect_ratio = "document" },
		[ordered]@{ name = "root_aspect_prefix_compat"; svg = "examples\xge_svg\assets\root_aspect_prefix_compat.svg"; tags = @("root-aspect-batch-147", "viewport", "preserve", "grammar"); xge_preserve_aspect_ratio = "document" },
		[ordered]@{ name = "root_aspect_defer_slice"; svg = "examples\xge_svg\assets\root_aspect_defer_slice.svg"; tags = @("root-aspect-batch-147", "viewport", "preserve", "grammar"); xge_preserve_aspect_ratio = "document" }
	)
	if ($IncludeExperimental) {
		...
		$cases += [ordered]@{ name = "css_subset"; svg = "examples\xge_svg\assets\css_subset.svg"; tags = @("remaining-core-batch-11"); experimental = $true }
